...
const IndexPage = () => (
  <Wrapper>
    ...
    <Row gutter={16}>
      <Col md={18} xs={24}>
        <p>I'm a Product Designer based from Manila, Philippines. Crafting experiences by gathering data from users to providing solutions for them, <Link to="/work">digitally.</Link></p>
