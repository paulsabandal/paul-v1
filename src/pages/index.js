...
const IndexPage = () => (
  <Wrapper>
    ...
    <Row gutter={16}>
      <Col md={18} xs={24}>
        <p>I'm a Product Designer based from Manila, Philippines. Crafting experiences using data gathered from users to providing a solutions for them, digitally.</p>
        ...
        <p>I'm helping to organize meetups for <a href="https://www.facebook.com/groups/1024359284439013/" target="_blank">Figma Philippines</a>. So far, we’ve done the first ever Figma event not just in the Philippines, but also in Asia.</p>
